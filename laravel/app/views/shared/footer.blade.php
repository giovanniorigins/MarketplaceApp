<footer class="main">
            <div class="footer-top-area">
                <div class="container">
                    <div class="row row-wrap">
                        <div class="col-md-3">
                            <a href="{{url('/')}}">
                                <img src="img/agora2_footer.png" alt="logo" title="logo" class="logo">
                            </a>
                            ...
                            <ul class="list unstyled">
                                <li>
                                    <a href="{{url('/about-us')}}">About Agora</a>
                                </li>
                                <li>
                                    <a href="{{url('/business')}}">Business Solutions</a>
                                </li>
                                <li>
                                    <a href="#">Blog</a>
                                </li>
                                ...
                                <li>
                                    {{--<a href="{{url('/about-us')}}">Privacy Statement</a>--}}
                                    <a href="//www.iubenda.com/privacy-policy/435658" class="iubenda-white iubenda-embed" title="Privacy Policy">Privacy Policy</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src = "//cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                {{ Form::open(array('url' => 'newsletter')) }}
                                    ...
                                    <p class="mb10">Join our mailing list to get great deals in your inbox!</p>
            ...
            <div class="footer-copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <p>Copyright © 2014, Agora, All Rights Reserved. All Currently listed Items are fake tests.</p>
                        </div>
