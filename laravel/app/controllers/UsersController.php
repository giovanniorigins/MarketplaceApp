...
class UsersController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($user->id) {
            ...
            $acc->save();
            // Newsletter Opt-in
            if (Input::get('newletter') == true) {
                $member = array(
                    'address' => $user->email,
                );
                Mailgun::lists()->addMember('newsletter@marketplace.gorigins.com', $member);
            }
    ...
    public function doForgotPassword()
    {
        if (Confide::forgotPassword(Input::get('email'))) {
            ...
            return Redirect::action('UsersController@doForgotPassword')->withInput()->with('error', $error_msg);
        }
    }
    ...
    public function doResetPassword()
    {
        ...
        if ($repo->resetPassword($input)) {
            ...
            return Redirect::action('UsersController@resetPassword', array('token' => $input['token']))->withInput()->with('error', $error_msg);
        }
    }
