  ...
  var browsers = {
    html5: new FakeBrowser('http://www.example.com/base/path?a=b#h', '/base/index2.html'),
    hashbang: new FakeBrowser('http://www.example.com/base/index2.html#!/path?a=b#h', '/base/index2.html')
  };
