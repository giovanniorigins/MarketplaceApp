(function () {
	...
	angular.module("app", ["ngRoute", "ngAnimate", "ngResource", "ngCookies", "dfUserManagement", "ngIdle",
		...
		return $routeProvider
			...
			.when("/admin/ui/typography", {templateUrl: "/admin_assets/views/ui/typography.html"})
			.when("/admin/ui/buttons", {templateUrl: "/admin_assets/views/ui/buttons.html"})
			.when("/admin/ui/icons", {templateUrl: "/admin_assets/views/ui/icons.html"})
			.when("/admin/ui/grids", {templateUrl: "/admin_assets/views/ui/grids.html"})
			.when("/admin/ui/widgets", {templateUrl: "/admin_assets/views/ui/widgets.html"})
			.when("/admin/ui/components", {templateUrl: "/admin_assets/views/ui/components.html"})
			.when("/admin/ui/timeline", {templateUrl: "/admin_assets/views/ui/timeline.html"})
			.when("/admin/ui/nested-lists", {templateUrl: "/admin_assets/views/ui/nested-lists.html"})
			.when("/admin/ui/pricing-tables", {templateUrl: "/admin_assets/views/ui/pricing-tables.html"})
			.when("/admin/forms/elements", {templateUrl: "/admin_assets/views/forms/elements.html"})
			.when("/admin/forms/layouts", {templateUrl: "/admin_assets/views/forms/layouts.html"})
			.when("/admin/forms/validation", {templateUrl: "/admin_assets/views/forms/validation.html"})
			.when("/admin/forms/wizard", {templateUrl: "/admin_assets/views/forms/wizard.html"})
			.when("/admin/maps/gmap", {templateUrl: "/admin_assets/views/maps/gmap.html"})
			.when("/admin/maps/jqvmap", {templateUrl: "/admin_assets/views/maps/jqvmap.html"})
			.when("/admin/tables/static", {templateUrl: "/admin_assets/views/tables/static.html"})
			.when("/admin/tables/responsive", {templateUrl: "/admin_assets/views/tables/responsive.html"})
			.when("/admin/tables/dynamic", {templateUrl: "/admin_assets/views/tables/dynamic.html"})
			.when("/admin/charts/others", {templateUrl: "/admin_assets/views/charts/charts.html"})
			.when("/admin/charts/morris", {templateUrl: "/admin_assets/views/charts/morris.html"})
			.when("/admin/charts/flot", {templateUrl: "/admin_assets/views/charts/flot.html"})
			.when("/admin/mail/inbox", {templateUrl: "/admin_assets/views/mail/inbox.html"})
			.when("/admin/mail/compose", {templateUrl: "/admin_assets/views/mail/compose.html"})
			.when("/admin/mail/single", {templateUrl: "/admin_assets/views/mail/single.html"})
			.when("/admin/pages/features", {templateUrl: "/admin_assets/views/pages/features.html"})
			.when("/admin/pages/signin", {templateUrl: "/admin_assets/views/pages/signin.html"})
			.when("/admin/pages/signup", {templateUrl: "/admin_assets/views/pages/signup.html"})
			.when("/admin/pages/forgot", {templateUrl: "/admin_assets/views/pages/forgot-password.html"})
			.when("/admin/pages/lock-screen", {templateUrl: "/admin_assets/views/pages/lock-screen.html"})
			.when("/admin/pages/profile", {templateUrl: "/admin_assets/views/pages/profile.html"})
			.when("/admin/404", {templateUrl: "/admin_assets/views/pages/404.html"})
			.when("/admin/500", {templateUrl: "/admin_assets/views/pages/500.html"})
			.when("/admin/pages/blank", {templateUrl: "/admin_assets/views/pages/blank.html"})
			.when("/admin/pages/invoice", {templateUrl: "/admin_assets/views/pages/invoice.html"})
			.when("/admin/pages/services", {templateUrl: "/admin_assets/views/pages/services.html"})
			.when("/admin/pages/about", {templateUrl: "/admin_assets/views/pages/about.html"})
			.when("/admin/pages/contact", {templateUrl: "/admin_assets/views/pages/contact.html"})
			.when("/admin/tasks", {templateUrl: "/admin_assets/views/tasks/tasks.html"})
			// My Pages
			.when("/admin/dashboard", {
				templateUrl: "admin_assets/views/dashboard.html",
			...
			.when("/admin/login", {templateUrl: "/admin_assets/views/pages/signin.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (UserDataService.getCurrentUser()) {
			...
			.when("/admin/logout", {templateUrl: "/admin_assets/views/pages/signout.html", controller: 'LogoutCtrl'})
			.when("/admin/register", 	{templateUrl: "/admin_assets/views/pages/signup.html"})
			.when("/admin/forgot", 	{templateUrl: "/admin_assets/views/pages/forgot-password.html"})
			.when('/register-confirm', {
				templateUrl: 'views/register-confirm.html'
			})
			.when("/admin/profile", {
				templateUrl: "admin_assets/views/pages/profile.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/user-management", {
				templateUrl: "admin_assets/views/pages/user-management.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/lock-screen", {
				templateUrl: "/admin_assets/views/pages/lock-screen.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/categories", {
				templateUrl: "/admin_assets/views/deals/categories.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/shops", {
				templateUrl: "/admin_assets/views/deals/shops.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/shops/:id", {
				templateUrl: "/admin_assets/views/deals/shop-edit.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
            ...
            .when("/admin/issues", {
                templateUrl: "/admin_assets/views/deals/issues.html",
                resolve: {
                    getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
                        if (!UserDataService.getCurrentUser()) {
                            $location.url('/admin/login')
            ...
            .when("/admin/deals", {
                templateUrl: "/admin_assets/views/deals/deals.html",
                resolve: {
                    getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
                        if (!UserDataService.getCurrentUser()) {
                            $location.url('/admin/login');
			...
			.when("/admin/coupons", {
				templateUrl: "/admin_assets/views/deals/coupons.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/coupons/:id", {
				templateUrl: "/admin_assets/views/deals/coupon-edit.html",
				resolve: {
					getUserData: ['$location', 'UserDataService', function($location, UserDataService) {
						if (!UserDataService.getCurrentUser()) {
							$location.url('/admin/login')
			...
			.when("/admin/pricing", {templateUrl: "admin_assets/views/ui/pricing-tables.html"})
			.when("/admin/services", {templateUrl: "admin_assets/views/pages/services.html"})
			.when("/admin/features", {templateUrl: "admin_assets/views/pages/features.html"})
			.when("/admin/about", {templateUrl: "admin_assets/views/pages/about.html"})
			.when("/admin/contact", {templateUrl: "admin_assets/views/pages/contact.html"})
			.when("/admin/home", {templateUrl: "admin_assets/views/pages/home.html"})
			.otherwise({redirectTo: "/admin/404"}),
