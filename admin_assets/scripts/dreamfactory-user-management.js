...
// Set constants for path resolution.
	...
	.constant('MODUSRMNGR_ASSET_PATH', '/admin_assets/bower_components/dreamfactory-user-management/')
...
// Define a router to handle module routes.  None used here
	...
	.run(['$cookieStore', '$http', 'UserDataService',
		function($cookieStore, $http, UserDataService) {
...
// and password stuff to complete the module.
	.controller('UserManagementCtrl', ['$scope',
		function($scope) {}
	])
...
// Forgot Password Email Confirmation
	.directive('dreamfactoryForgotPwordEmail', ['MODUSRMNGR_ASSET_PATH', 'DSP_URL', '$http', 'UserEventsService',
...
// Forgot Password Security Question
	.directive('dreamfactoryForgotPwordQuestion', ['MODUSRMNGR_ASSET_PATH',
		function(MODUSRMNGR_ASSET_PATH) {
...
// service where ever you need to access the current user.
	...
	.service('dfXHRHelper', ['DSP_URL', 'DSP_API_KEY', '$cookies',
		function(DSP_URL, DSP_API_KEY, $cookies) {
